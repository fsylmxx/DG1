...
dir_path = r'/public_data/p2018/DESTINATION/training/'



seq_dir = '/data/lijinyang/SleepSLeep/SleepDG-main/dataa/p2018/seq'
label_dir = '/data/lijinyang/SleepSLeep/SleepDG-main/dataa/p2018/labels'
